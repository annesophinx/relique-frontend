  ...
  render(){
    const template = html`
      ...
      <div class="page-content">        
        ...
        `:html`
        <lottie-player class="pro" src="https://assets4.lottiefiles.com/private_files/lf30_LOw4AL.json"  background="transparent"  speed="1"  style="width: 20em; height: 20em;"  loop autoplay></lottie-player>
          
          <form class="page-form input-validation-required" @submit=${this.updateProfileSubmitHandler.bind(this)} enctype="multipart/form-data">
